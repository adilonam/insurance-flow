  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        ...
        // Set selected partner if exists
        if (user.partner) {
  ...
  const onSubmit = async (data: UpdateUserFormValues) => {
    try {
      ...
      if (data.name !== undefined) {
        payload.name = data.name && data.name.trim() !== "" ? data.name : null;
      }
      ...
      if (data.partnerId !== undefined) {
        payload.partnerId = data.partnerId && data.partnerId.trim() !== "" ? data.partnerId : null;
      }
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>New password (leave blank to keep current password)</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
